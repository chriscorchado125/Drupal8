 ...
 */
export const configureSearchForm = (): void => {
  let subFolder = ''
  let clearSearchURL = ''
  ...
  const checkForSearchContainer = setInterval(() => {
    if (document.getElementById('search-container')) {
      ...
      /**
       * Set a 'clear' querystring param in order to set
       * focus to the search box after the search is cleared
       */
      ...
      if (params.get('search_api')) {
         ...
         * and remove the 'clear' querystring param
         */
